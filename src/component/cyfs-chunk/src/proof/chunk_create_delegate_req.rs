...
pub struct ChunkCreateDelegateReq {
...
impl ChunkCreateDelegateReq {
    pub fn sign(source_signer: &PeerSecret, source_device_id:&Peerid,  miner_device_id:&Peerid, chunk_id:&Chunkid, balance: &i64, price:&i64)->BuckyResult<ChunkCreateDelegateReq>{
