...
pub struct ChunkMergeStub {
    // message fields
    pub index_range_start: u32,
    pub index_range_end: u32,
    pub len: u64,
    pub offset: u64,
    // message oneof groups
    pub _first_range_start: ::std::option::Option<ChunkMergeStub_oneof__first_range_start>,
    pub _first_range_end: ::std::option::Option<ChunkMergeStub_oneof__first_range_end>,
    pub _last_range_start: ::std::option::Option<ChunkMergeStub_oneof__last_range_start>,
    pub _last_range_end: ::std::option::Option<ChunkMergeStub_oneof__last_range_end>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
#[derive(Clone,PartialEq,Debug)]
pub enum ChunkMergeStub_oneof__first_range_start {
    first_range_start(u64),
}

#[derive(Clone,PartialEq,Debug)]
pub enum ChunkMergeStub_oneof__first_range_end {
    first_range_end(u64),
}

#[derive(Clone,PartialEq,Debug)]
pub enum ChunkMergeStub_oneof__last_range_start {
    last_range_start(u64),
}

#[derive(Clone,PartialEq,Debug)]
pub enum ChunkMergeStub_oneof__last_range_end {
    last_range_end(u64),
}
...
impl ChunkMergeStub {
    ...
    // uint64 first_range_start = 1;


    pub fn get_first_range_start(&self) -> u64 {
        match self._first_range_start {
            ::std::option::Option::Some(ChunkMergeStub_oneof__first_range_start::first_range_start(v)) => v,
            _ => 0,
        }
    }
    pub fn clear_first_range_start(&mut self) {
        self._first_range_start = ::std::option::Option::None;
    }

    pub fn has_first_range_start(&self) -> bool {
        match self._first_range_start {
            ::std::option::Option::Some(ChunkMergeStub_oneof__first_range_start::first_range_start(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_first_range_start(&mut self, v: u64) {
        self._first_range_start = ::std::option::Option::Some(ChunkMergeStub_oneof__first_range_start::first_range_start(v))
    }

    // uint64 first_range_end = 2;


    pub fn get_first_range_end(&self) -> u64 {
        match self._first_range_end {
            ::std::option::Option::Some(ChunkMergeStub_oneof__first_range_end::first_range_end(v)) => v,
            _ => 0,
        }
    }
    pub fn clear_first_range_end(&mut self) {
        self._first_range_end = ::std::option::Option::None;
    }

    pub fn has_first_range_end(&self) -> bool {
        match self._first_range_end {
            ::std::option::Option::Some(ChunkMergeStub_oneof__first_range_end::first_range_end(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_first_range_end(&mut self, v: u64) {
        self._first_range_end = ::std::option::Option::Some(ChunkMergeStub_oneof__first_range_end::first_range_end(v))
    }

    // uint32 index_range_start = 3;


    pub fn get_index_range_start(&self) -> u32 {
        self.index_range_start
    }
    pub fn clear_index_range_start(&mut self) {
        self.index_range_start = 0;
    }

    // Param is passed by value, moved
    pub fn set_index_range_start(&mut self, v: u32) {
        self.index_range_start = v;
    }

    // uint32 index_range_end = 4;


    pub fn get_index_range_end(&self) -> u32 {
        self.index_range_end
    }
    pub fn clear_index_range_end(&mut self) {
        self.index_range_end = 0;
    }

    // Param is passed by value, moved
    pub fn set_index_range_end(&mut self, v: u32) {
        self.index_range_end = v;
    }

    // uint64 last_range_start = 5;


    pub fn get_last_range_start(&self) -> u64 {
        match self._last_range_start {
            ::std::option::Option::Some(ChunkMergeStub_oneof__last_range_start::last_range_start(v)) => v,
            _ => 0,
        }
    }
    pub fn clear_last_range_start(&mut self) {
        self._last_range_start = ::std::option::Option::None;
    }

    pub fn has_last_range_start(&self) -> bool {
        match self._last_range_start {
            ::std::option::Option::Some(ChunkMergeStub_oneof__last_range_start::last_range_start(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_last_range_start(&mut self, v: u64) {
        self._last_range_start = ::std::option::Option::Some(ChunkMergeStub_oneof__last_range_start::last_range_start(v))
    }

    // uint64 last_range_end = 6;


    pub fn get_last_range_end(&self) -> u64 {
        match self._last_range_end {
            ::std::option::Option::Some(ChunkMergeStub_oneof__last_range_end::last_range_end(v)) => v,
            _ => 0,
        }
    }
    pub fn clear_last_range_end(&mut self) {
        self._last_range_end = ::std::option::Option::None;
    }

    pub fn has_last_range_end(&self) -> bool {
        match self._last_range_end {
            ::std::option::Option::Some(ChunkMergeStub_oneof__last_range_end::last_range_end(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_last_range_end(&mut self, v: u64) {
        self._last_range_end = ::std::option::Option::Some(ChunkMergeStub_oneof__last_range_end::last_range_end(v))
    }
...
impl ::protobuf::Message for ChunkMergeStub {
        ...
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ...
                    self._first_range_start = ::std::option::Option::Some(ChunkMergeStub_oneof__first_range_start::first_range_start(is.read_uint64()?));
                },
                2 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self._first_range_end = ::std::option::Option::Some(ChunkMergeStub_oneof__first_range_end::first_range_end(is.read_uint64()?));
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                4 => {
                    ...
                    let tmp = is.read_uint32()?;
                    self.index_range_end = tmp;
                },
                5 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self._last_range_start = ::std::option::Option::Some(ChunkMergeStub_oneof__last_range_start::last_range_start(is.read_uint64()?));
                },
                6 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self._last_range_end = ::std::option::Option::Some(ChunkMergeStub_oneof__last_range_end::last_range_end(is.read_uint64()?));
                },
                7 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if self.index_range_start != 0 {
            my_size += ::protobuf::rt::value_size(3, self.index_range_start, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.index_range_end != 0 {
            my_size += ::protobuf::rt::value_size(4, self.index_range_end, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.len != 0 {
            my_size += ::protobuf::rt::value_size(7, self.len, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.offset != 0 {
            my_size += ::protobuf::rt::value_size(8, self.offset, ::protobuf::wire_format::WireTypeVarint);
        }
        if let ::std::option::Option::Some(ref v) = self._first_range_start {
            match v {
                &ChunkMergeStub_oneof__first_range_start::first_range_start(v) => {
                    my_size += ::protobuf::rt::value_size(1, v, ::protobuf::wire_format::WireTypeVarint);
                },
            };
        }
        if let ::std::option::Option::Some(ref v) = self._first_range_end {
            match v {
                &ChunkMergeStub_oneof__first_range_end::first_range_end(v) => {
                    my_size += ::protobuf::rt::value_size(2, v, ::protobuf::wire_format::WireTypeVarint);
                },
            };
        }
        if let ::std::option::Option::Some(ref v) = self._last_range_start {
            match v {
                &ChunkMergeStub_oneof__last_range_start::last_range_start(v) => {
                    my_size += ::protobuf::rt::value_size(5, v, ::protobuf::wire_format::WireTypeVarint);
                },
            };
        }
        if let ::std::option::Option::Some(ref v) = self._last_range_end {
            match v {
                &ChunkMergeStub_oneof__last_range_end::last_range_end(v) => {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        if self.index_range_start != 0 {
            os.write_uint32(3, self.index_range_start)?;
        }
        if self.index_range_end != 0 {
            os.write_uint32(4, self.index_range_end)?;
        }
        if self.len != 0 {
            os.write_uint64(7, self.len)?;
        }
        if self.offset != 0 {
            os.write_uint64(8, self.offset)?;
        }
        if let ::std::option::Option::Some(ref v) = self._first_range_start {
            match v {
                &ChunkMergeStub_oneof__first_range_start::first_range_start(v) => {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_u64_accessor::<_>(
                "first_range_start",
                ChunkMergeStub::has_first_range_start,
                ChunkMergeStub::get_first_range_start,
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_u64_accessor::<_>(
                "first_range_end",
                ChunkMergeStub::has_first_range_end,
                ChunkMergeStub::get_first_range_end,
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "index_range_start",
                |m: &ChunkMergeStub| { &m.index_range_start },
                |m: &mut ChunkMergeStub| { &mut m.index_range_start },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "index_range_end",
                |m: &ChunkMergeStub| { &m.index_range_end },
                |m: &mut ChunkMergeStub| { &mut m.index_range_end },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_u64_accessor::<_>(
                "last_range_start",
                ChunkMergeStub::has_last_range_start,
                ChunkMergeStub::get_last_range_start,
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_u64_accessor::<_>(
                "last_range_end",
                ChunkMergeStub::has_last_range_end,
                ChunkMergeStub::get_last_range_end,
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                "len",
                |m: &ChunkMergeStub| { &m.len },
                |m: &mut ChunkMergeStub| { &mut m.len },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                "offset",
                |m: &ChunkMergeStub| { &m.offset },
                |m: &mut ChunkMergeStub| { &mut m.offset },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x01(\x0b2\x0e.ContractStateR\x05state\"\x98\x03\n\x0eChunkMergeStub\
    \x12/\n\x11first_range_start\x18\x01\x20\x01(\x04H\0R\x0ffirstRangeStart\
    \x88\x01\x01\x12+\n\x0ffirst_range_end\x18\x02\x20\x01(\x04H\x01R\rfirst\
    RangeEnd\x88\x01\x01\x12*\n\x11index_range_start\x18\x03\x20\x01(\rR\x0f\
    indexRangeStart\x12&\n\x0findex_range_end\x18\x04\x20\x01(\rR\rindexRang\
    eEnd\x12-\n\x10last_range_start\x18\x05\x20\x01(\x04H\x02R\x0elastRangeS\
    tart\x88\x01\x01\x12)\n\x0elast_range_end\x18\x06\x20\x01(\x04H\x03R\x0c\
    lastRangeEnd\x88\x01\x01\x12\x10\n\x03len\x18\x07\x20\x01(\x04R\x03len\
    \x12\x16\n\x06offset\x18\x08\x20\x01(\x04R\x06offsetB\x14\n\x12_first_ra\
    nge_startB\x12\n\x10_first_range_endB\x13\n\x11_last_range_startB\x11\n\
    \x0f_last_range_end\"r\n\x12ChunkFunctionMerge\x12\x15\n\x03key\x18\x01\
    \x20\x01(\x0cH\0R\x03key\x88\x01\x01\x12'\n\x06chunks\x18\x02\x20\x01(\
    \x0b2\x0f.ChunkMergeStubR\x06chunks\x12\x14\n\x05split\x18\x03\x20\x01(\
    \rR\x05splitB\x06\n\x04_key\"G\n\x12DataSourceStubDesc\x121\n\tfunctions\
    \x18\x01\x20\x03(\x0b2\x13.ChunkFunctionMergeR\tfunctionsb\x06proto3\
";
