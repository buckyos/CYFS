...
With the help of tools in the future, developers only need to write .proto files to generate all the code. However, we have not yet completed this tool, and from the perspective of architecture, we definitely support manual extension of DEC Object, and there is no harm in mastering the principle. This process is relatively mechanical and cumbersome. Basically, after you have the proto file, you can fill it out according to the template. Here is a brief explanation:
